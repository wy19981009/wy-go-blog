...
func init() {
	//执行main之前 先执行init方法
	dataSourceName := fmt.Sprintf("gosql:Yxl5201314...@tcp(gz-cdb-eg3lodhn.sql.tencentcdb.com:63499)/gosql?charset=utf8&loc=%s&parseTime=true", url.QueryEscape("Asia/Shanghai"))
